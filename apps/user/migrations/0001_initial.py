    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(blank=True, max_length=250, null=True, verbose_name='senha')),
                ('is_superuser', models.BooleanField(default=False, verbose_name='super usuário')),
                ('is_staff', models.BooleanField(default=False, verbose_name='usuário do sistema')),
